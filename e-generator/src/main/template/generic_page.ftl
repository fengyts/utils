...
public class Page<T> implements Serializable {
	...
	public static final int DEFAULT_PAGESIZE_TWO = 2; // 默认每页数量
	
	public static final int DEFAULT_PAGESIZE_TEN = 10; // 默认每页数量
	
	public static final int DEFAULT_PAGESIZE_TWENTY = 20; // 默认每页数量

	public static final int DEFAULT_PAGENO = 1; // 默认起始页数
